...
set_property PACKAGE_PIN V16 [get_ports music_en]                    
...
set_property PACKAGE_PIN T18 [get_ports set_up]                        
    set_property IOSTANDARD LVCMOS33 [get_ports set_up]
set_property PACKAGE_PIN W19 [get_ports set_left]                        
    set_property IOSTANDARD LVCMOS33 [get_ports set_left]
set_property PACKAGE_PIN T17 [get_ports set_right]                        
    set_property IOSTANDARD LVCMOS33 [get_ports set_right]
set_property PACKAGE_PIN U17 [get_ports set_down]                        
    set_property IOSTANDARD LVCMOS33 [get_ports set_down]
